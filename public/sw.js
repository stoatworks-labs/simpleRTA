...
const CACHE = 'simple-rta-v1';

// Enough to boot offline. Everything else arrives through runtime caching.
//
// rta-worklet.js is not optional and is not in /assets/: it lives in public/,
// so Vite neither hashes nor bundles it, and the runtime rule below would let
// it straight through to a network that is not there. Without it the page
// loads offline and then cannot start the analyser, which is the entire app.
// about.js and about-data.js are the same shape of problem, less fatally.
const SHELL = [
  '/',
